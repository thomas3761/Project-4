...
class SpaceJam(ShowBase):
    def __init__(self):
        ...
        self.Spaceship = spaceJamClasses.Spaceship(self.loader, self.render, "./Assets/Dumbledore/Dumbledore.egg", self.render, "Spaceship", "./Assets/Dumbledore/spacejet_C.png", Vec3(0, 0, 0), 50, self.taskMgr, self.accept)
